                    ...
                    <div className="row">
                                ...
                                <div className="img1">
                                    {/*<svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32"
                                        ...
                                        <path
                                            ...
                                            stroke="#ED8438" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round"/>
                                    </svg>*/}
                                </div>
                                <div className="content">
                                    <p>Our Email</p>
                                    <Link  to="mailto:Housarealesate@gmail.com">Housarealesate@gmail.com</Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="phone-number">
                                <div className="img1">
                                    {/*<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"
                                        ...
                                        <path
                                            ...
                                            stroke="#ED8438" stroke-width="2.5"/>
                                        <path
                                ...
                                <div className="content">
                                    <p>Schedule</p>
                                    <Link to="tel:+11234567890">Sunday-Fri: 9 AM – 6 PM</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            ...
                                            <div className="input-area text-end">
                                                <button type="submit" className="vl-btn1">Submit Now <span
                                                    className="arrow1"><i
                                                    className="fa-solid fa-arrow-right"></i></span><span
                                                    className="arrow2"><i
